...
from src.core import InitializingEquation, WorldState, SelfInitializingModel
...
class MassBalanceA(InitializingEquation):
    ...
    def initialize(self, ws: WorldState) -> Dict[str, Decimal]:
        sol1, sol2 = _quadratic_eq(ws.k3, ws.qr / ws.Vr + ws.k1, - ws.qr / ws.Vr * ws.Ca_0)
...
def _quadratic_eq(a: Decimal, b: Decimal, c: Decimal) -> (Decimal, Decimal):
    d = (b ** 2) - (4 * a * c)
